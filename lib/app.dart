...
import 'package:projetomobile/views/register.dart';
...
class MovieDexApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // O seu ThemeData (tema) permanece o mesmo
      theme: ThemeData(
      ...
      // A rota inicial é a raiz
      initialRoute: '/',

      // O mapa de rotas agora aponta para os arquivos dentro de /views/
      routes: {
